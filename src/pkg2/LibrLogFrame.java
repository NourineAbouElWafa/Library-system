 ...
 * @author User
 */
public class LibrLogFrame extends javax.swing.JFrame {

    /**
     * Creates new form LibrLogFrame
     */
    public LibrLogFrame() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (user.isEmpty() || !BookFrame.isAlphabet(user)) {
            ...
            try {
                if(Librarian.isValid(user, pass)){
                ...
                Logger.getLogger(LibrLogFrame.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LibrLogFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>

        //</editor-fold>
        /* Create and display the form */
        LibrLogFrame x = new LibrLogFrame();
        x.setLocationRelativeTo(null);
        x.setVisible(true);
